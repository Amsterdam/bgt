...
# bijvoorbeeld: sh import_mapping_GML_DB_CSV.sh C:\\BGT\\BGT_import_mapping_gml_db_csv\\CSV 10.62.86.193 bgt_dev_local 5433 bgt
...
psql -h ${db_server} -d ${database} -p ${db_port} -U ${db_user} -c "\COPY imgeo_controle.mapping_gml_db(gmlnaam,dbnaam) FROM '${locatie_CSV}/mapping.csv' DELIMITER ';' CSV HEADER;"

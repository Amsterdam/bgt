        ...
        response = requests.post(
            ...
            data=json.dumps({
                ...
                "publishedParameters": [
                    ...
                    # TODO: inlezen met 2e FME bestand, kan hier weg. parameters zetten in FME!
                    {
        ...
        data=json.dumps({
            ...
            "publishedParameters": [
                ...
                },
                {
                    ...
                    "value": "$(FME_SHAREDRESOURCE_DATA)/Export_Shapes.zip"  # check of dit zorgt voor download of ZIP.
                },
                {

...
\qecho
\qecho '*******************************************************************************'
\qecho '* Aanmaak view imgeo_extractie.vw_bgt_pand ...                                *'
\qecho '*******************************************************************************'
\qecho
...
DROP VIEW IF EXISTS imgeo_extractie.vw_bgt_pand;


CREATE OR REPLACE VIEW imgeo_extractie.vw_bgt_pand
AS
(
...
\qecho
\qecho '*******************************************************************************'
\qecho '* Klaar met aanmaak view imgeo_extractie.vw_bgt_pand.                         *'
\qecho '*******************************************************************************'
\qecho

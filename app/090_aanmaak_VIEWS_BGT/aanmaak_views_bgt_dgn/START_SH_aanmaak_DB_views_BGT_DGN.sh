...
logbestand=${working_dir}/log/aanmaak_DB_views_BGT_DGN.${datum_tijd}.log
...
echo "*******************************************************************************"
echo "* Start script $0 ..."
echo "* Aanmaken extractie-DGN-views in schema imgeo_extractie BGT-database ...     *"
echo "*******************************************************************************"
echo
...
echo "* Klaar met aanmaken extractie-DGN-views in schema imgeo_extractie BGT-DB.    *"
echo "*******************************************************************************"
echo 

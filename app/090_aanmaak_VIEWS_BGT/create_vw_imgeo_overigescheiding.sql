...
\qecho
\qecho '*******************************************************************************'
\qecho '* Aanmaak view imgeo_extractie.vw_imgeo_overigescheiding ...                  *'
\qecho '*******************************************************************************'
\qecho
...
DROP VIEW IF EXISTS imgeo_extractie.vw_imgeo_overigescheiding;

CREATE OR REPLACE VIEW imgeo_extractie.vw_imgeo_overigescheiding
AS
(
...
\qecho
\qecho '*******************************************************************************'
\qecho '* Klaar met aanmaak view imgeo_extractie.vw_imgeo_overigescheiding.           *'
\qecho '*******************************************************************************'
\qecho
